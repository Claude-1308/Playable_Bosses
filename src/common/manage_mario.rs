    ...
    if WorkModule::is_flag(module_accessor,FIGHTER_MARIO_INSTANCE_WORK_ID_FLAG_IS_BOSS) {
        if WorkModule::is_flag(module_accessor,FIGHTER_MARIO_INSTANCE_WORK_ID_FLAG_IS_BOSS_DEAD) {
            ...
            match kind {
                ...
                BossKind::LIOLEUSBOSS => WorkModule::set_int(module_accessor,Lioleusboss::finish_frame,FIGHTER_MARIO_INSTANCE_WORK_ID_INT_MOVE_HOLD_TIMER),
                BossKind::GALLEOM => WorkModule::set_int(module_accessor,Galleom::finish_frame,FIGHTER_MARIO_INSTANCE_WORK_ID_INT_MOVE_HOLD_TIMER),
                BossKind::MARX => WorkModule::set_int(module_accessor,Marx::finish_frame,FIGHTER_MARIO_INSTANCE_WORK_ID_INT_MOVE_HOLD_TIMER),
                BossKind::DRACULA => WorkModule::set_int(module_accessor,Dracula::finish_frame,FIGHTER_MARIO_INSTANCE_WORK_ID_INT_MOVE_HOLD_TIMER),
                BossKind::DRACULA2 => WorkModule::set_int(module_accessor,Dracula::finish_frame_2,FIGHTER_MARIO_INSTANCE_WORK_ID_INT_MOVE_HOLD_TIMER),
                BossKind::DARZ => WorkModule::set_int(module_accessor,Darz::finish_frame,FIGHTER_MARIO_INSTANCE_WORK_ID_INT_MOVE_HOLD_TIMER),
                BossKind::KIILA => WorkModule::set_int(module_accessor,Kiila::finish_frame,FIGHTER_MARIO_INSTANCE_WORK_ID_INT_MOVE_HOLD_TIMER),
                _ => {},
            };
...
unsafe fn dead_main_loop(fighter: &mut L2CFighterCommon) -> L2CValue {
    ...
    if WorkModule::get_int(module_accessor,FIGHTER_MARIO_INSTANCE_WORK_ID_INT_MOVE_HOLD_TIMER) <= 0 {
        ...
        if WorkModule::get_int(module_accessor,FIGHTER_MARIO_INSTANCE_WORK_ID_INT_BOSS_KIND) == BossKind::DRACULA2 {
            WorkModule::set_int(module_accessor,BossKind::DRACULA,FIGHTER_MARIO_INSTANCE_WORK_ID_INT_BOSS_KIND);
        }
