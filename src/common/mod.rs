...
unsafe fn change_active_camera_hook(manager: u64, change_to: i32, current: i32, arg4: u64, arg5: i32) -> u64 {
    println!("change_to: {}",change_to);
    original!()(manager,change_to,current,arg4,arg5)
}
...
pub fn install() {
    ...
    skyline::install_hooks!(notify_log_event_collision_hit_replace,change_active_camera_hook);
}