...
impl BossKind {
    ...
    pub const GALLEOM: i32 = 4;
    pub const MARX: i32 = 5;
    pub const DRACULA: i32 = 6;
    pub const DRACULA2: i32 = 7;
    pub const DARZ: i32 = 8;
    pub const KIILA: i32 = 9;
}

//pub static mut SLOT: [i8; 8] = [-1; 8];
pub static mut BOSS_TYPE: [u64; 8] = [0; 8];
...
extern "C" {
    ...
    pub fn item__self_param_float(kind: ItemKind, hash: Hash40) -> f32;
}

extern "C" {
    #[link_name = "\u{1}_ZN3app4item27set_camera_range_from_paramEP9lua_StateNS_8ItemKindEN3phx6Hash40E"]
    pub fn item__set_camera_range_from_param(lua_state: u64, kind: ItemKind, hash: Hash40);
}

extern "C" {
    #[link_name = "\u{1}_ZN3app4item29self_struct_array_param_floatENS_8ItemKindEN3phx6Hash40EmS3_"]
    pub fn item__self_struct_array_param_float(kind: ItemKind, hash_out: Hash40, index: u64, hash_in: Hash40) -> f32;
}

extern "C" {
    #[link_name = "\u{1}_ZN3app4item27self_struct_array_param_intENS_8ItemKindEN3phx6Hash40EmS3_"]
    pub fn item__self_struct_array_param_int(kind: ItemKind, hash_out: Hash40, index: u64, hash_in: Hash40) -> i32;
}
...
pub unsafe fn update_css(unk: u64) {
    let unk1 = (unk + 0x238) as *mut u64;
    let unk2 = (unk + 0x240) as *mut u64;
    println!("unk1: {}",*unk1);
    println!("unk1: {}",*unk2);
    original!()(unk)
}
...
pub fn install() {
    ...
    skyline::install_hooks!(
        ...
        self_param_int_replace,
        item__self_struct_array_param_int_replace,
