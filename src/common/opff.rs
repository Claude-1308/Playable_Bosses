    ...
    unsafe {
        ...
        if smashball::is_training_mode() {
            ...
            && sv_information::is_ready_go() {
                ...
                let boss_names = ["MASTER HAND", "MARIO MHAND", "LINK MHAND", "CPT. FALCON MHAND", "ZSS MHAND", "RYU MHAND", "CLOUD MHAND", "JOKER MHAND",
                                  "WARIO CHAND", "GANON CHAND", "BAYONETTA CHAND", "DARK SAMUS CHAND", "KAZUYA CHAND", "SEPHIROTH CHAND", "WOLF CHAND", "CRAZY HAND",
                                  "BEAST GANON", "RATHALOS", "GALLEOM", "MARX"];
                for boss_name in boss_names {
                    if name == hash40(boss_name) {
