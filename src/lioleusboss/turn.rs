...
pub unsafe fn turn_status(item: &mut L2CAgentBase) -> L2CValue {
    ...
    if AttackModule::is_attack(module_accessor,0,false) {
        ...
        AttackModule::set_power(module_accessor,1,20.0,false);
        AttackModule::set_power(module_accessor,3,20.0,false);
        AttackModule::set_power(module_accessor,4,20.0,false);
    }
