...
pub const ITEM_CRAZYHAND_STATUS_KIND_FIRE_FLARE_START: i32 = 0x92;
pub const ITEM_CRAZYHAND_STATUS_KIND_FIRE_FLARE_LOOP: i32 = 0x93;
pub const ITEM_CRAZYHAND_STATUS_KIND_FIRE_FLARE_END: i32 = 0x94;
pub const ITEM_CRAZYHAND_STATUS_KIND_ENTRY: i32 = 0x95;

pub struct CHFireStatus(i32);

impl CHFireStatus {
    pub const SHOOT: i32 = 1;
    const TYPE1: i32 = 2;
    const TYPE2: i32 = 3;
    const TYPE3: i32 = 4;
}
